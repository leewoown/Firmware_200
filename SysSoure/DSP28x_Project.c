...
//    s->SysCanRxCount=0;
   ...
   /*
    ...
    s->SlaveReadVoltEn.bit.SlaveBMS12=1;
    s->SlaveReadVoltEn.bit.SlaveBMS13=1;
    s->SlaveReadVoltEn.bit.SlaveBMS14=1;
    s->SlaveReadVoltEn.bit.SlaveBMS15=1;
    ...
    s->SlaveReadTempsEn.bit.SlaveBMS12=1;
    s->SlaveReadTempsEn.bit.SlaveBMS13=1;
    s->SlaveReadTempsEn.bit.SlaveBMS14=1;
    s->SlaveReadTempsEn.bit.SlaveBMS15=1;
...
void SysAlarmtCheck(SystemReg *s)
{
 /*
    ...
    {
         s->SysAlarmReg.bit.PackCT_OC=1;
    }
    else
    {
        s->SysAlarmReg.bit.PackCT_OC=0;
    }
