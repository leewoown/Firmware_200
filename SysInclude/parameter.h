...
#define     CellVoltSampleTime   350
#define     CellTempSampleTime   50

#define     Product_Type                       3    // 25.03.04
#define     Product_Version                    00   // 25.03.04
#define     Product_SysCellVauleS              176
#define     Product_SysCellVauleP              1
#define     Product_Voltage                    647// 3.664*24
#define     Product_Capacity                   480 // 52


#define     C_PackVoltMax                   1008 //4.2*24
#define     C_PackVoltMin                   42  //2.8*2.4
...
#define     C_SysModuleEa                 8 // Module 개수를  정의함
#define     C_SlaveMEAEa                  11 // Slave BMS에서 측정하는 전압 및 온도 개수 정의함
#define     C_ModuleMEAEa                 22 // Module에서 측정하는 셀 전압 및 온도 개수를 정의함
#define     C_SlaveBMSEa                  16

#define     C_SysCellVoltEa               C_SysModuleEa*C_ModuleMEAEa // Battery Pack 내 Cell 전압 EA
#define     C_SysCellTempEa               C_SysModuleEa*C_ModuleMEAEa // Battery Pack 내 Cell 온도 EA
