...
#define ProtectOFFTNRelayOFFTime           50
#define PrtctWakeupOnTimeOut               25000
#define PrtctWakeupOFFTimeOut              25000
/*
...
{       // bits   description
    ...
    unsigned int     PWRLatchOn                 :1; // 7
    unsigned int     PWRLatchOFF                :1; // 8
    unsigned int     WakeuPOnEND                :1; // 9
    unsigned int     WakeuPOffEND               :1; // 10
    unsigned int     RlyFaulttSate              :1; // 11
    unsigned int     WakeupOFFTiemrErr          :1; // 12
    unsigned int     WakeupOnTiemrErr           :1; // 13
    unsigned int     CANPRlyDO                  :1; // 14
    unsigned int     CANNRlyDO                  :1; // 15
    unsigned int     CANPreRlyDO               :1; // 16
};
union ProtectRelaySate_REG
{
    struct ProtectRelayState_BIT    bit;
    struct ProtectRelayState_BYTE   Byte;
    unsigned int                     all;
};
